...
interface BlockConfigPanelProps {
    ...
    globalSettings?: {
        ...
        homeWidgetTitleFontSize?: string;
        homeWidgetTitleFontWeight?: string;
        homeWidgetTitleLineHeight?: string;
        homeWidgetTitleFont?: string;
        homeNewsTitleFontSize?: string;
        homeNewsTitleFontWeight?: string;
        homeNewsTitleLineHeight?: string;
        homeNewsTitleFont?: string;
        homeExcerptFontSize?: string;
        homeExcerptFontWeight?: string;
        homeExcerptLineHeight?: string;
        homeExcerptFont?: string;
        homeMetaFontSize?: string;
        homeMetaFontWeight?: string;
        homeMetaLineHeight?: string;
        homeMetaFont?: string;

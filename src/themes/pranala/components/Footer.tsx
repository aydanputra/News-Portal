...
export default function Footer({ siteName, logoUrl, footerConfig, menusByLocation, categories, setting }: FooterProps) {
  const year = new Date().getFullYear();
  const hasBuilderFooter = Array.isArray(footerConfig) && footerConfig.length > 0;
  const footerTextFontFamily = resolveThemeFontFamily(setting?.globalContentFont || setting?.bodyFont || "Inter", "Inter");

  if (!hasBuilderFooter) {
    return (
      <footer className="py-16 bg-[color:var(--bg-surface,#111827)] [color:var(--home-excerpt-color,#d1d5db)]" suppressHydrationWarning>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
            ...
            <div className="w-full md:w-1/3 flex flex-col items-center md:items-end gap-4">
              <div className="flex gap-4">
                <a href="#" className="p-2 bg-[color:var(--bg-elevated,#1f2937)] rounded-full hover:bg-[color:var(--accent,#2563eb)] hover:text-white transition-colors">
                  <Facebook size={18} />
                </a>
                <a href="#" className="p-2 bg-[color:var(--bg-elevated,#1f2937)] rounded-full hover:bg-[color:var(--accent,#2563eb)] hover:text-white transition-colors">
                  <Twitter size={18} />
  ...
  const renderWidget = (widget: any) => {
          ...
          <ul className="space-y-2 text-sm font-medium">
            {footerMenu.map((item: any) => (
              <li key={item.id}>
                <Link
                  href={item.href || "#"}
                  className="hover:[color:var(--home-hover-color,var(--accent,#2563eb))] transition-colors"
    ...
    if (widget.type === "footer_text") {
      ...
      const desktopColor = resolveOptionalColor(getResponsive(config, "textColor", "desktop")) || "var(--home-excerpt-color, #9ca3af)";
      ...
      const desktopTitleColor = resolveOptionalColor(getResponsive(config, "blockTitleColor", "desktop")) || "var(--home-widget-title-color, #9ca3af)";
      ...
      const desktopTitleSize = resolveOptionalPx(getResponsive(config, "blockTitleFontSize", "desktop")) || "12px";
      ...
      const desktopTitleBorder = resolveOptionalColor(getResponsive(config, "blockTitleBorderColor", "desktop")) || "rgba(156, 163, 175, 0.28)";
      ...
      const styleVars: React.CSSProperties = {
        ...
        ["--fb-ft-font-family" as any]: footerTextFontFamily,
      };
      return (
        <div className={`space-y-3 ${alignClass}`.trim()}>
          {showTitle && (
          ...
          {clean.trim() !== "" && (
            <div
              suppressHydrationWarning
              style={styleVars}
              className="fb-footer-text max-w-full break-words whitespace-normal [color:var(--fb-ft-color-mobile,var(--fb-ft-color-desktop,var(--home-excerpt-color,#9ca3af)))] md:[color:var(--fb-ft-color-tablet,var(--fb-ft-color-desktop,var(--home-excerpt-color,#9ca3af)))] lg:[color:var(--fb-ft-color-desktop,var(--home-excerpt-color,#9ca3af))] [font-family:var(--fb-ft-font-family,var(--font-body,sans-serif))] text-[length:var(--fb-ft-size-mobile,var(--fb-ft-size-desktop,14px))] md:text-[length:var(--fb-ft-size-tablet,var(--fb-ft-size-desktop,14px))] lg:text-[length:var(--fb-ft-size-desktop,14px)] leading-[var(--fb-ft-lh-mobile,var(--fb-ft-lh-desktop,1.625))] md:leading-[var(--fb-ft-lh-tablet,var(--fb-ft-lh-desktop,1.625))] lg:leading-[var(--fb-ft-lh-desktop,1.625)] font-[var(--fb-ft-fw-mobile,var(--fb-ft-fw-desktop,400))] md:font-[var(--fb-ft-fw-tablet,var(--fb-ft-fw-desktop,400))] lg:font-[var(--fb-ft-fw-desktop,400)] [&_*]:max-w-full [&_*]:overflow-wrap-anywhere [&_*]:break-words [&_*]:whitespace-normal [&_a]:text-inherit [&_a:hover]:[color:var(--home-hover-color,var(--accent,#2563eb))] [&_a]:underline-offset-4 [&_a:hover]:underline [&_p]:m-0 [&_b]:font-bold [&_strong]:font-bold [&_img]:max-w-full [&_img]:h-auto [&_video]:max-w-full [&_video]:h-auto [&_iframe]:max-w-full [&_table]:block [&_table]:max-w-full [&_table]:overflow-x-auto"
    ...
    if (widget.type === "footer_social") {
      ...
      const effectiveVariant = variant === "theme" ? "button" : variant;
      ...
      const desktopSize = resolveOptionalPx(getResponsive(config, "socialIconSize", "desktop")) || "18px";
      ...
      const desktopColor = resolveOptionalColor(getResponsive(config, "socialIconColor", "desktop")) || "var(--home-meta-color, #9ca3af)";
      ...
      const desktopHover = resolveOptionalColor(getResponsive(config, "socialIconHoverColor", "desktop")) || "var(--home-hover-color, var(--accent, #2563eb))";
      ...
      const defaultBg = "var(--bg-elevated, #1f2937)";
      const defaultBgHover = "var(--accent, #4f46e5)";
                ...
                <a
                  ...
                  className={
                    effectiveVariant === "button"
                      ? `inline-flex items-center justify-center rounded-[var(--fb-sl-radius,9999px)] p-[var(--fb-sl-pad-mobile,var(--fb-sl-pad-desktop,8px))] md:p-[var(--fb-sl-pad-tablet,var(--fb-sl-pad-desktop,8px))] bg-[color:var(--fb-sl-bg-mobile,var(--fb-sl-bg-desktop,#1f2937))] md:bg-[color:var(--fb-sl-bg-tablet,var(--fb-sl-bg-desktop,#1f2937))] hover:bg-[color:var(--fb-sl-bg-hover-mobile,var(--fb-sl-bg-hover-desktop,#4f46e5))] md:hover:bg-[color:var(--fb-sl-bg-hover-tablet,var(--fb-sl-bg-hover-desktop,#4f46e5))] [color:var(--fb-sl-color-mobile,var(--fb-sl-color-desktop,#9ca3af))] md:[color:var(--fb-sl-color-tablet,var(--fb-sl-color-desktop,#9ca3af))] hover:[color:var(--fb-sl-hover-mobile,var(--fb-sl-hover-desktop,#ffffff))] md:hover:[color:var(--fb-sl-hover-tablet,var(--fb-sl-hover-desktop,#ffffff))] transition-colors`.trim()
    ...
    if (widget.type === "footer_custom_links") {
      ...
      const desktopColor = resolveOptionalColor(getResponsive(config, "linkColor", "desktop")) || "var(--home-excerpt-color, #9ca3af)";
      ...
      const desktopHover = resolveOptionalColor(getResponsive(config, "linkHoverColor", "desktop")) || "var(--home-hover-color, var(--accent, #2563eb))";
      ...
      const desktopWeight = scalar(getResponsive(config, "linkFontWeight", "desktop")) || "500";
              ...
              return (
                <li key={`${item.label}_${idx}`} className={layout === "horizontal" ? "flex items-center" : undefined}>
                  {isInternal ? (
                    <Link
                      href={item.url}
                      className={`text-inherit transition-colors hover:[color:var(--fb-cl-hover-mobile,var(--fb-cl-hover-desktop,var(--home-hover-color,var(--accent,#2563eb))))] md:hover:[color:var(--fb-cl-hover-tablet,var(--fb-cl-hover-desktop,var(--home-hover-color,var(--accent,#2563eb))))] lg:hover:[color:var(--fb-cl-hover-desktop,var(--home-hover-color,var(--accent,#2563eb)))] ${linkBase}`.trim()}
                    >
                      {item.label}
                    </Link>
                  ) : (
    ...
    if (widget.type === "footer_copyright") {
      ...
      const desktopColor = resolveOptionalColor(getResponsive(config, "textColor", "desktop")) || "var(--home-meta-color, #9ca3af)";
      const tabletColor = resolveOptionalColor(getResponsive(config, "textColor", "tablet")) || desktopColor;
      const mobileColor = resolveOptionalColor(getResponsive(config, "textColor", "mobile")) || desktopColor;
      const desktopSize = resolveOptionalPx(getResponsive(config, "textFontSize", "desktop")) || "12px";
      const tabletSize = resolveOptionalPx(getResponsive(config, "textFontSize", "tablet")) || desktopSize;
      const mobileSize = resolveOptionalPx(getResponsive(config, "textFontSize", "mobile")) || desktopSize;
  ...
  return (
    <footer className="[color:var(--home-excerpt-color,#9ca3af)]" suppressHydrationWarning>
      <div className="w-full">
        {sections.map((section) => {
          ...
          const bgM = normalizeColor(rawBgM, useBoxMobile ? "var(--bg-elevated, #ffffff)" : "transparent");

    ...
    <div className="p-6 md:p-8 bg-[var(--bg-base)] max-w-[1600px] mx-auto relative min-h-screen pb-32 page-builder">
      ...
      <EditChildModal
        ...
        globalSettings={{
          ...
          homeWidgetTitleFontSize: state.homeWidgetTitleFontSize,
          homeWidgetTitleFontWeight: state.homeWidgetTitleFontWeight,
          homeWidgetTitleLineHeight: state.homeWidgetTitleLineHeight,
          homeWidgetTitleFont: state.homeWidgetTitleFont,
          homeNewsTitleFontSize: state.homeNewsTitleFontSize,
          homeNewsTitleFontWeight: state.homeNewsTitleFontWeight,
          homeNewsTitleLineHeight: state.homeNewsTitleLineHeight,
          homeNewsTitleFont: state.homeNewsTitleFont,
          homeExcerptFontSize: state.homeExcerptFontSize,
          homeExcerptFontWeight: state.homeExcerptFontWeight,
          homeExcerptLineHeight: state.homeExcerptLineHeight,
          homeExcerptFont: state.homeExcerptFont,
          homeMetaFontSize: state.homeMetaFontSize,
          homeMetaFontWeight: state.homeMetaFontWeight,
          homeMetaLineHeight: state.homeMetaLineHeight,
          homeMetaFont: state.homeMetaFont,

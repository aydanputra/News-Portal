...
import { useFooterBuilder } from "./useFooterBuilder";

export default function FooterAppearancePage() {
  const { state, actions } = useFooterBuilder();
  ...
  return (
    <div className="p-6 md:p-8 bg-[var(--bg-base)] max-w-[1600px] mx-auto relative min-h-screen pb-32 page-builder">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="font-display text-2xl md:text-3xl font-bold text-[var(--fg-primary)]">Footer Builder</h1>
          <p className="text-[var(--fg-secondary)] mt-1">Atur section dan kolom footer. Widget yang tersedia mengikuti tema aktif.</p>
        </div>

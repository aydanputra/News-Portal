...
export default function EditPostPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    async function fetchData() {
        try {
            const [categoriesRes, usersRes, postRes] = await Promise.all([
  ...
  function handlePreview() {
    ...
    const previewData = {
      ...
      gallery,
      status: "PREVIEW",
      author: { name: "Preview Author" }, // TODO: Get actual author name
  ...
  return (
    <div className="p-6 md:p-8 admin-form bg-[var(--bg-base)] min-h-screen relative">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-[var(--fg-primary)]">Edit Berita</h1>
